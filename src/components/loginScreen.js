...
class LoginScreen extends Component {
    ...
    constructor() {
        ...
        this.state = {
            placeholderText: 'Qual o seu número?'
        }
    }
    componentWillMount() {
    ...
    increaseHeightOfLogin = () => {
        ...
        this.setState({ placeholderText: '4002-8922' })
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <ImageBackground
                    source={require('../img/frominsta.jpg')}
                    style={{ flex: 1 }}
                >
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Animatable.View
                            animation="zoomIn" iterationCount={1}
                            style={{ backgroundColor: 'white', height: 100, width: 100, alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 26 }}>cb</Text>
                        </Animatable.View>
                    </View>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Flag code="BR" size={24} type="flat" style={{resizeMode: 'contain'}} />
                                    <Animated.View
                                        pointerEvents="none"
                                        style={{
                                            flexDirection: 'row',
